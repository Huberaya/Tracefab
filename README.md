...
**Chantier 17 — Quality Center API / Collection Reminders / Notification Outbox / Data Collection Productization / Data Collection API / Product Data API / supplier onboarding / Neon + Clerk**
...
- écran frontend Brand Console ;
- écran frontend Supplier Portal ;
- écran frontend Quality Center ;
- OCR/Document Intelligence ;
- score de qualité calculé ;
- rendu public DPP ;
- API publique et connecteurs ERP/PLM/PIM.

Voir `docs/architecture/` pour les décisions et contrats versionnés des chantiers 1 à 17 et de l'intégration Neon/Clerk.
