...
**Chantier 12 — Product Data API / supplier onboarding / Neon + Clerk**
...
Voir `docs/architecture/` pour les décisions et contrats versionnés des chantiers 1 à 12 et de l'intégration Neon/Clerk.
